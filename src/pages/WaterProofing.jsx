    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-yellow-100 to-yellow-50 pb-7">
            ...
            <div className="text-gray-600 text-sm py-4 px-6">
                Ranchi / Waterproofing Contractors in Chennai / <span className="font-medium">1665+ Listings</span>
            </div>
            <div className="text-center mb-6 p-6">
                <h1 className="text-2xl font-bold text-gray-800">
                Waterproofing Contractors in Ranchi
                </h1>
                <p className="text-gray-600 mt-1 text-sm">
                Enquire & Get Excellent Services with the Waterproofing Services in Ranchi
                </p>
            </div>
            {/* Main Content */}
                ...
                <div className="p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                                <span className="text-gray-800">Waterproofing Services</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className=" text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                        <span className="text-gray-800">Waterproofing material details</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className=" text-red-500"></FontAwesomeIcon>
                        </button>
                    </div>
                </div>
