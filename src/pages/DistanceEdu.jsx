    ...
    return (
        <div className="min-h-screen bg-gradient-to-b from-yellow-100 to-yellow-50 pb-7">
            ...
            <div className="text-gray-600 text-sm py-4 px-6">
                Ranchi / Distance Education in Ranchi / <span className="font-medium">1665+ Listings</span>
            </div>
            <div className="text-center mb-6 p-6">
                <h1 className="text-2xl font-bold text-gray-800">
                    Distance Education in Ranchi
                </h1>
                <p className="text-gray-600 mt-1 text-sm">
                    Drive Your Success with Distance Learning
                </p>
            </div>
            {/* Main Content */}
                ...
                <div className="p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 h-72 overflow-y-auto">
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800">Media Distance Education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className=" text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800">Management distance education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className="text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800 text-left">Arts &amp; Humanities distance education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className=" text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800">Engineering distance education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className=" text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800">Computer science distance education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className="text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800">Finance &amp; Accounts distance education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className=" text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800">Medical distance education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className=" text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800">Teaching distance education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className="text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800">Science distance education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className=" text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800">Open school distance education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className=" text-red-500"></FontAwesomeIcon>
                        </button>
                        <button className="flex justify-between items-center bg-gray-50 hover:bg-gray-100 px-4 py-3 rounded-md shadow-md">
                            <span className="text-gray-800">Law distance education</span>
                            <FontAwesomeIcon icon={faChevronCircleRight} className="text-red-500"></FontAwesomeIcon>
                        </button>
                    </div>
                </div>
